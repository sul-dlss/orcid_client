  ...
  describe "#update_work" do
    it "updates works" do
      VCR.use_cassette("Sul_Orcid_Client/_update_work/updates work") do
        expect(client.update_work(orcidid: "https://sandbox.orcid.org/0000-0003-3437-349X", put_code: "1754266", work:, token: "FAKE29cb-194e-4bc3-8afg-99315b06be0468cf29cb-294e-4bc8-8afd-96315b06ae04")).to be true
      end
    end
    ...
    context "when server returns an error" do
      it "raises" do
        VCR.use_cassette("Sul_Orcid_Client/_update_work/raises") do
          expect { client.update_work(orcidid: "https://sandbox.orcid.org/0000-0003-3437-349X", put_code: "1754266", work:, token: "FAKE29cb-194e-4bc3-8afg-99315b06be0468cf29cb-294e-4bc8-8afd-96315b06ae04") }.to raise_error(StandardError)
        end
      end
    end
  end
