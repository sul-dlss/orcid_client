...
RSpec.describe SulOrcidClient do
  ...
  describe "#fetch_name" do
    let(:fetch_name_response) { subject.fetch_name(orcidid: "https://sandbox.orcid.org/0000-0002-2230-4756") }
    let(:bogus_fetch_name_response) { subject.fetch_name(orcidid: "bogus") }
  ...
  describe "#search" do
    context "when a regular search" do
      let(:search_response) { subject.search(query: "(ringgold-org-id:6429)") }
      let(:big_search_response) { subject.search(query: "test") }
    ...
    context "when an expanded search" do
      let(:search_response) { subject.search(query: "(ringgold-org-id:6429)", expanded: true) }
      let(:big_search_response) { subject.search(query: "test", expanded: true) }
  ...
  describe "#fetch_works" do
    let(:works_response) { subject.fetch_works(orcidid: "https://sandbox.orcid.org/0000-0002-7262-6251") }
  ...
  describe "#add_work" do
    ...
    let(:put_code) { subject.add_work(orcidid: "https://sandbox.orcid.org/0000-0003-3437-349X", work:, token: "FAKE29cb-194e-4bc3-8afg-99315b06be04") }
  ...
  describe "#fetch_work" do
    let(:work_response) { subject.fetch_work(orcidid: "https://orcid.org/0000-0003-1527-0030", put_code: "15473562") }
  ...
  describe "#delete_work" do
    let(:work_deleted) { subject.delete_work(orcidid: "https://sandbox.orcid.org/0000-0002-2230-4756", put_code: "1253255", token: "c4a9b3a4-f868-4cd1-8d7f-1d5rfd9f4bdb") }
